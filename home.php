                ...
                <?php 
                    ...
                    <div class="col-lg-3">
                     <div class="card menu-item ">
                        <img src="assets/img/<?php echo $row['img_path'] ?>" class="card-img-top" alt="..." width="300" height="300">
                        <div class="card-body">
                          <h5 class="card-title"><?php echo $row['name'] ?></h5>
                          <p class="card-text truncate" style=" font-family: 'Roboto', sans-serif;"><?php echo $row['description'] ?></p>
                          <h6 class="card-text">Commssion:25%</h4>
