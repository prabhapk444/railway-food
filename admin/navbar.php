...
<nav id="sidebar" class='mx-lt-5 bg-dark'>
		<div class="sidebar-list">
				...
				<a href="index.php?page=employe" class="nav-item nav-site_settings"><span class='icon-field'><i class="fa fa-user"></i></span>Employee</a>
                <a href="index.php?page=train" class="nav-item nav-site_settings"><span class='icon-field'><i class="fa fa-train"></i></span>Train</a>
				<?php if($_SESSION['login_type'] == 1): ?>
				<a href="index.php?page=users" class="nav-item nav-users"><span class='icon-field'><i class="fa fa-users"></i></span> Users</a>
				<a href="index.php?page=amount" class="nav-item nav-users">
    <span class='icon-field'><i class="fa fa-shopping-cart"></i></span>Total Amount
</a>
